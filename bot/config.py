...
STYLE_PROMPT_MAP = {
    "Акварель": (
        ...
        "Если это свадьба, нарисуй только ОДНУ пару: жениха и невесту вместе. "
    ...
    "Масло": (
        "Классическая живопись маслом на холсте, фон для дизайна. Тематика: {occasion}. "
        "По краям холста детализированные тематические элементы, символизирующие {occasion}. "
        "Если это свадьба, нарисуй только ОДНУ пару: жениха и невесту вместе, держащихся за руки. "
    ...
    "Неон": (
        "Киберпанк неоновый фон. Тематика: {occasion}. "
    ...
    "Пастель": (
        "Фон нарисованный сухой пастелью, мягкие мелки. Тематика: {occasion}. "
        "По краям холста детализированные тематические элементы, символизирующие {occasion}. "
        "Если это свадьба, нарисуй только ОДНУ романтичную пару: жениха и невесту. "
    ...
    "Винтаж": (
        "Старинный винтажный фон в стиле советских почтовых открыток. Тематика: {occasion}. "
        "По краям холста детализированные тематические элементы, символизирующие {occasion}. "
        "Если это свадьба, нарисуй только ОДНУ пару: жениха и невесту. "
    ...
    "Минимализм": (
        ...
        "По краям холста тематические элементы, символизирующие {occasion}. "
        "Если это свадьба, нарисуй только ОДИН силуэт пары: жениха и невесту. "
